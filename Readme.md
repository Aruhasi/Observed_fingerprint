...
│   ├── SAT_function_Obs_Fingerprint.py      # Subordinate functions
├── docs/                    # Demo input datasets
├── scripts/          # the main analyses scripts and plotting of corresponding figures
     ── FIGs
     ── Supp_Figures/           # Scripts for supporting information
```
---
## 4. How to Run
