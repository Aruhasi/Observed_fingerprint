...
client, scluster = scluster.init_dask_slurm_cluster(walltime="01:00:00")
...
ds_IPSL_1850_2022 = xr.open_mfdataset(dir_residuals + 'GSAT_IPSL_Internal_Variability_anomalies_1850_2022.nc',
                                      chunks={'run':1})
...
# In[7]:
# ds_IPSL_1850_2022 = ds_IPSL_1850_2022.rename({'__xarray_dataarray_variable__': 'tas'})
# In[8]:
...
for i in time_interval:
    ICV_segments[i] = generate_segments(ds_IPSL_1850_2022['tas'], segment_length=i)
# In[10]:
...
new_ds
# In[12]:
ds_combined = xr.merge([ds_IPSL_1850_2022, new_ds])
# In[13]:
ds_combined
# In[14]:
...
# In[21]:
ds_output = '/work/mh0033/m301036/Land_surf_temp/Disentangling_OBS_SAT_trend/Figure2/IPSL/'
