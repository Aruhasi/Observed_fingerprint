...
def init_dask_slurm_cluster(scale = 2, processes = 64, walltime="06:00:00", memory="256GiB"):
    dask.config.set(
        {
            "distributed.worker.data-directory": "/scratch/m/m301036/dask_temp",
    ...
    scluster = SLURMCluster(
        ...
        processes       = processes,
        account         = "mh0033",
        name            = "m301036-dask-cluster",
        interface       = "ib0",
        asynchronous    = False,
        log_directory   = "/scratch/m/m301036/dask_logs/",
        local_directory = "/scratch/m/m301036/dask_temp/",
    )
