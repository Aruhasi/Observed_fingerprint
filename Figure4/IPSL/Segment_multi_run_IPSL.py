...
#         dir_residuals + 'GSAT_IPSL_Internal_Variability_anomalies_1850_2022.nc',
...
def main(runs):
    ...
    combined_results = compute_trend(ds_IPSL_1850_2022, segment_lengths, func_mk)
    # Initialize a list to hold results
    # delayed_trend_results = []

    # for run in runs:  # Iterate over runs
    #     # Select the current run
    #     ds_run = ds_IPSL_1850_2022.sel(run=run)
    ...
    output_path = os.path.join(dir_output, f'IPSL_ICV_segments_1850_2022_run{runs}_trend.nc')
