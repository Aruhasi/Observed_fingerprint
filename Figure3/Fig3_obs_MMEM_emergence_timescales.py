...
#         ha='center', va='center')  # Label for SOP
# Save the figure
fig.savefig('Fig3-Final.png', dpi=300, bbox_inches='tight')
fig.savefig('Fig3-Final.pdf', dpi=300, bbox_inches='tight')
fig.savefig('Fig3-Final.eps', dpi=300, bbox_inches='tight')
plt.show()
# %%