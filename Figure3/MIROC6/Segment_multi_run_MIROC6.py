...
# dir_output = '/work/mh0033/m301036/Land_surf_temp/Disentangling_OBS_SAT_trend/LE_evaluation/Fig3_MIROC6/output/'
    
#     # Load dataset
# ds_MIROC6_1850_2022 = xr.open_mfdataset(
#         dir_residuals + 'GSAT_MIROC6_Internal_Variability_anomalies_1850_2022.nc',
...
def main(runs):
    ...
    combined_results = compute_trend(ds_MIROC6_1850_2022, segment_lengths, func_mk)
    # Initialize a list to hold results
    # delayed_trend_results = []

    # for run in runs:  # Iterate over runs
    #     # Select the current run
    #     ds_run = ds_MIROC6_1850_2022.sel(run=run)
    ...
    output_path = os.path.join(dir_output, f'MIROC6_ICV_segments_1850_2022_run{runs}_trend.nc')
