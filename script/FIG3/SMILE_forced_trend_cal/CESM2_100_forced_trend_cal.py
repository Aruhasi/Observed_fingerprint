...
dir_out = f"/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIG3/{model}/SMILE_forced"
...
def process_ensmean_forced(model):
    ...
    and variables:
        ...
        p_value (MK p-value)
    """
    in_file = f"{dir_in}/{model}_annual_ano_ensemble_mean_1950_2022_cmip6+smbb.nc"
...
if rank == 0:
    ...
    out_file = (
        f"{dir_out}/{model}_CMIP6+smbb_ENSmean_forced_MK_trend_"
