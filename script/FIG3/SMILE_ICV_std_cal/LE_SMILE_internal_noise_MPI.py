...
def load_data_for_model(model_name):
    # members
    mem_file = os.path.join(dir_members, f"tas_{model_name}_annual_ano_1850_2022.nc")
    ...
    # ENS mean
    ens_file = os.path.join(dir_ens, f"{model_name}_annual_ano_ensemble_mean_1950_2022.nc")
