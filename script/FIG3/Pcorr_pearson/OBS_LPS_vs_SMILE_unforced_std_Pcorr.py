...
def compute_run_vs_mmem_correlations(tas_mem: xr.DataArray,
    ...
    for ir in local_indices:
        ...
        for ip in range(n_period):
            ...
            # Pattern correlation
            corr_val = pattern_corr_da(LE_trend_map, internal_map)
...
def compute_obs_vs_mmem_correlations(obs_trend: xr.DataArray,
    ...
    for ip, period_label in enumerate(period_labels):
        ...
        corr_obs[ip] = pattern_corr_da(obs_map, internal_map)
...
corr_global = compute_run_vs_mmem_correlations(tas_mem, internal_trend)
...
if rank == 0:
    ...
    corr_obs = compute_obs_vs_mmem_correlations(obs_trend, internal_trend)
