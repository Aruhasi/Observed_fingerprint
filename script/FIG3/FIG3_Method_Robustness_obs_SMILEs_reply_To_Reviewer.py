...
MMEM_unforced_corr = {'2013-2022': [0.68], '1993-2022': [0.61], '1963-2022': [0.59], '1979-2022': [0.61]}
# %%
...
# %%
area_weighted_OBS = area_weighted_rms(HadCRUT5_trend.trend, HadCRUT5_trend.lat)
area_weighted_DIFF = area_weighted_rms(pattern_diff, pattern_diff.lat)
print(area_weighted_OBS)
print(area_weighted_DIFF)
# %%
bias_fraction = 100.0 * area_weighted_DIFF / area_weighted_OBS
print(bias_fraction)
# %%
...
# %%
print(bias_fraction.min().values)
# calculate the global mean values
mean_ratio = bias_fraction.sel(period="1979-2022")
...
print(ICV_diff)
# %%
area_weighted_ICV_OBS = area_weighted_rms(HadCRUT5_internal_trend, HadCRUT5_internal_trend.lat)
area_weighted_ICV_DIFF = area_weighted_rms(ICV_diff, ICV_diff.lat)
print(area_weighted_ICV_OBS)
print(area_weighted_ICV_DIFF)
# %%
...
# %%
# calculate the global mean values
bias_fraction_icv = 100.0 * area_weighted_ICV_DIFF / area_weighted_ICV_OBS
print(bias_fraction_icv)
# %%
mean_ratio_ICV = bias_fraction_icv.sel(period="1979-2022", trend_length=44)
# %%
# ============================================================================
...
def create_figure(include_1979=False):
    ...
    for i, segment in enumerate(time_segments):
        ...
        if (i == 2) and include_1979:
            mmem_value = MMEM_unforced_corr[segment][0] + 0.005  # slight offset for visibility
            ax_pdf_icv.axvline(mmem_value, color=colors[i], linestyle='-.', linewidth=5.5, 
                               label=f"r(Obs, MMEM)({segment}) (offset)")
        else:
    ...
    ax_forced_map.set_title("MMLE - OBS\n(1979-2022)", fontsize=28, pad=10, loc='center')
    ...
    p_icv = ICV_diff.sel(period="1979-2022", trend_length=44).plot(
        ax=ax_icv_map,
        transform=ccrs.PlateCarree(),
        cmap=cmap_icv,
        norm=norm_icv,
...
for ext in ("png", "pdf"):
    ...
    fig_with_1979.savefig(figure_output + f"Fig3_with_1979_2022_ReplyToReviewer.{ext}", dpi=300, bbox_inches='tight')
