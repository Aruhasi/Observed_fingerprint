...
#SBATCH --mem=32G
#SBATCH --output=le_Internal_rmse_%j.out
#SBATCH --error=le_Internal_rmse_%j.err
...
mpirun -np ${SLURM_NTASKS} python -u OBS_LPS_vs_SMILE_unforced_std_RMSE.py $model \
