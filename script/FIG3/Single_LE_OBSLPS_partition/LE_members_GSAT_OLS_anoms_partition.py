...
# ds_CESM2LE = xr.open_dataset(f'{FIELD_DIR}/CMIP6_tas_annual_mean_all_members.nc')
...
def process_model(model_name):
    ...
    out_file = model_out_dir / f"SAT_anomaly_partition_wrt_{model_name}_ENS_GSAT_{START_YEAR}-{END_YEAR}.nc"
