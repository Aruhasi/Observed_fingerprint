...
if rank == 0:
    ...
    ds_all = xr.open_mfdataset(temp_files, combine="nested", concat_dim="run")
    out_file = f"{dir_out}/forced_{model}_CMIP6_SMBB_MK_trend_{start_year}-{end_year}_sliding.nc"
