...
# %%
# %%
dir_MMLE = "/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIG4/median/"
...
diff = MMEM['emergence_timescale_median'] - data_obs['emergence_timescale_mean']
...
for ext in ("png", "pdf"):
    fig.savefig(figure_output+f"FIG4_SNgt2_median_emergence_timescales_update_regions.{ext}", dpi=300, bbox_inches='tight')
