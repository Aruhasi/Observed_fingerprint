...
# %%
dir_in = "/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIG4/7LEs_CESM2_cmip6_output/mean/"
MIROC6_ENS = xr.open_dataset(dir_in + "MIROC6_emergence_timescale_mean.nc")
# MIROC6_ENS = MIROC6_ENS.rename_vars({'__xarray_dataarray_variable__': 'emergence_timescale_mean'})
MPI_ENS = xr.open_dataset(dir_in + "MPI_ESM_emergence_timescale_mean.nc")
# MPI_ENS = MPI_ENS.rename_vars({'__xarray_dataarray_variable__': 'emergence_timescale_mean'})
ACCESS_ENS = xr.open_dataset(dir_in + "ACCESS_emergence_timescale_mean.nc")
# ACCESS_ENS = ACCESS_ENS.rename_vars({'__xarray_dataarray_variable__': 'emergence_timescale_mean'})
EC_Earth3 = xr.open_dataset(dir_in + "EC_Earth3_emergence_timescale_mean.nc")
# EC_Earth3 = EC_Earth3.rename_vars({'__xarray_dataarray_variable__': 'emergence_timescale_mean'})
IPSL_ENS = xr.open_dataset(dir_in + "IPSL_CM6A_emergence_timescale_mean.nc")
# IPSL_ENS = IPSL_ENS.rename_vars({'__xarray_dataarray_variable__': 'emergence_timescale_mean'})
CanESM5_ENS = xr.open_dataset(dir_in + "CanESM5_emergence_timescale_mean.nc")
# CanESM5_ENS = CanESM5_ENS.rename_vars({'__xarray_dataarray_variable__': 'emergence_timescale_mean'})
# %%
CESM2_ENS = xr.open_dataset("/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIG4/CESM_emergence_timescale_mean.nc")
CESM2_ENS = CESM2_ENS.rename_vars({'__xarray_dataarray_variable__': 'emergence_timescale_mean'})
# %%
models = {
    "MIROC6": MIROC6_ENS["emergence_timescale_mean"],
    "CESM2": CESM2_ENS["emergence_timescale_mean"],
    "MPI-ESM": MPI_ENS["emergence_timescale_mean"],
    "ACCESS": ACCESS_ENS["emergence_timescale_mean"],
    "EC-Earth3": EC_Earth3["emergence_timescale_mean"],
    "IPSL": IPSL_ENS["emergence_timescale_mean"],
    "CanESM5": CanESM5_ENS["emergence_timescale_mean"],
}
...
# (B) multi-model **mean**
MMEM_mean = stack.mean("model")
# %%
MMEM_mean.to_dataset(name="emergence_timescale_mean").to_netcdf("/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIG4/MMEM_emergence_timescale_mean.nc")
# %%
...
MMEM_mean = MMEM_mean.where(MMEM_mean != -1)
diff = data_obs - MMEM_mean
...
#         ha='center', va='center')  # Label for SOP
# Save the figure
fig.savefig('OBS_MMLE_SN_gt_2.png', dpi=300, bbox_inches='tight')
fig.savefig('OBS_MMLE_SN_gt_2.pdf', dpi=300, bbox_inches='tight')
# fig.savefig('OBS_MMLE_SN_gt_2.eps', dpi=300, bbox_inches='tight')
plt.show()
# %%