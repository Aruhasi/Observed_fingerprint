...
def func_mk(x):
    ...
    return slope, p_val
# %%
dir_in = "/work/mh0033/m301036/OBS_LPS_revision/docs/data/OBS_data/"
...
def main():
    ...
    """
    in_file = f"{dir_in}/tas_{OBS}_annual_anomalies.nc"
    ...
    out_file = f"{dir_out}/Raw_{OBS}_MK_trend_{start_year}-{end_year}_sliding.nc"
