...
OBS = OBS_data[1]  # 'NOAA'
dir_in = "/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIGS_OBS_records"
dir_out = f"/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIGS_OBS_records/trend_forced_{OBS}_annual/"
...
def process_model(model):
    ...
    """
    in_file = f"{dir_in}/{OBS}_SAT_anomaly_partition_wrt_{model}_ENS.nc"
    ...
    out_file = f"{dir_out}/forced_{OBS}_{model}_MK_trend_{start_year}-{end_year}_sliding.nc"
