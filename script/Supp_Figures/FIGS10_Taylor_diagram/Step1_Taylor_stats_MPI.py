...
def main():
    ...
    p.add_argument("--obs", default=None, help="Optional NetCDF: trend(period, lat, lon)")
    p.add_argument("--var", default="trend", help="Variable name (default: trend)")
    ...
    mem = ds_mem[args.var]   # (run, period, lat, lon)
    ref = ds_ref[args.var]   # (period, lat, lon)
