...
IN_DIR = "/work/mh0033/m301036/OBS_LPS_revision/docs/data/Revision_check/SMILE_actual_residual_ICV/"
...
# model = "IPSL_CM6A"
# input merged file
IN_FILE = f"{IN_DIR}/{model}/per_run_patterns/{model}_run{run_id:03d}_OBS_LPS_ICV_MKtrend_patterns_1950_2022_sliding.nc"
...
if "run" in ds_full.dims:
    ...
    # fall back to single-run files without run dimension
    trend = ds_full["trend"]
...
# output per-run
OUT_DIR = f"{IN_DIR}/{model}/regional_anomalies"
os.makedirs(OUT_DIR, exist_ok=True)
OUT_FILE = f"{OUT_DIR}/{model}_run{run_id:03d}_regional_mean_trends_ICV_1950_2022_sliding.nc"
tmp = OUT_FILE + ".tmp"
