...
dir_out = f"/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIGS_OBS_records/trend_ICV_{OBS}_annual"
...
def process_model(model):
    ...
    out_file = f"{dir_out}/ICV_{OBS}_{model}_MK_trend_{start_year}-{end_year}_sliding.nc"
