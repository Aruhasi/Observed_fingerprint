...
# SMILE_unforced_trend = xr.open_dataset('/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIG5/SMILE_residual_ICV/MMLE_avg_of_7LEs_5th_95th_quantile_1950_2022_sliding.nc')
SMILE_unforced_trend = xr.open_dataset('/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIG5/SMILE_residual_ICV/MMLE_equal_weighted_5th_95th_quantile_1950_2022_sliding.nc')
SMILE_unforced_trend
# %%
...
ax1.fill_between(np.arange(1950,2014), arctic_unforced_lower.ICV_trend_lower.values[::-1], arctic_unforced_upper.ICV_trend_upper.values[::-1], color=colors[3])
ax2.fill_between(np.arange(1950,2014), NAWH_unforced_lower.ICV_trend_lower.values[::-1], NAWH_unforced_upper.ICV_trend_upper.values[::-1], color=colors[3])
...
# ax2.text(1979.1, -0.96, '1979-2022', fontsize=20, rotation=90, color='#999A9E')
# ax3.text(1979.1, -1.46, '1979-2022', fontsize=20, rotation=90, color='#999A9E')
# ax4.text(1979.1, -0.56, '1979-2022', fontsize=20, rotation=90, color='#999A9E')

# Add subplot order text
ax1.text(1943, 1.58, 'A', fontsize=35, ha='center', va='center', fontweight='bold')
ax2.text(1943, 1.58, 'B', fontsize=35, ha='center', va='center', fontweight='bold')
ax3.text(1943, 1.74, 'C', fontsize=35, ha='center', va='center', fontweight='bold')
...
plt.savefig(f'{dir_fig_output}FIG5_SMILE_icv_equal_weighted_5th_95th_quantile.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{dir_fig_output}FIG5_SMILE_icv_equal_weighted_5th_95th_quantile.pdf', dpi=300, bbox_inches='tight')
