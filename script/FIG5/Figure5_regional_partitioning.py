...
dir_percentile = '/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIG5/data/percentile/'
...
arctic_unforced_lower = xr.open_dataset(f'{dir_percentile}internal_arctic_trend_lower_percentile.nc')
NAWH_unforced_lower = xr.open_dataset(f'{dir_percentile}internal_subpolar_gyre_trend_lower_percentile.nc')
SEP_unforced_lower = xr.open_dataset(f'{dir_percentile}internal_SEP_trend_lower_percentile.nc')
SOP_unforced_lower = xr.open_dataset(f'{dir_SOP_percentile}internal_SOP_trend_lower_percentile.nc')

arctic_unforced_upper = xr.open_dataset(f'{dir_percentile}internal_arctic_trend_upper_percentile.nc')
NAWH_unforced_upper = xr.open_dataset(f'{dir_percentile}internal_subpolar_gyre_trend_upper_percentile.nc')
SEP_unforced_upper = xr.open_dataset(f'{dir_percentile}internal_SEP_trend_upper_percentile.nc')
