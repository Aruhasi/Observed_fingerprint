...
# %% 
MODELS = ['CanESM5', 'IPSL_CM6A', 'EC_Earth3', 'ACCESS', 'MPI_ESM', 'MIROC6']
# MODELS = ['IPSL_CM6A']
# MODELS = ['ACCESS']
...
# %%
dir_out = "/work/mh0033/m301036/OBS_LPS_revision/docs/data/FIG5/SMILE_residual_ICV_check_6LEs"
os.makedirs(dir_out, exist_ok=True)
out_nc = f"{dir_out}/MMLE_equal_weighted_5th_95th_quantile_1950_2022_sliding.nc"
...
SOP_unforced_lower    = MMLE_icv_env["q_low"].sel(region='SOP_original')
...
SOP_unforced_upper    = MMLE_icv_env["q_high"].sel(region='SOP_original')
# %%
