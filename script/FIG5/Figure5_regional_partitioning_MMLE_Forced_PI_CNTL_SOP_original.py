...
PI_unforced_trend = xr.open_dataset('/work/mh0033/m301036/OBS_LPS_revision/docs/data/Revision_check/PI_control_ICV/Data_sop_original/PI_Control_percentiles.nc')
PI_unforced_trend
# %%
...
# set the labels for y-axis as two decimal places for
ax3.yaxis.set_major_formatter(FormatStrFormatter('%.1f'))
# show y-axis ticks at every 0.5 interval
...
plt.savefig(f'{dir_fig_output}FIG5_piControl_SOP_original.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{dir_fig_output}FIG5_piControl_SOP_original.pdf', dpi=300, bbox_inches='tight')
