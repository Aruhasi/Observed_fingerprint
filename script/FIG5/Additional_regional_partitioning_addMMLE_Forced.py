...
gs = gridspec.GridSpec(1, 2, wspace=0.25, hspace=0.7)
...
for ax, low, high in [
    (ax1, NPM_PI_unforced_lower.values[::-1], NPM_PI_unforced_upper.values[::-1]),
    (ax2, SO_PI_unforced_lower.values[::-1],  SO_PI_unforced_upper.values[::-1]),
]:
...
for ax_upper in [ax1_upper, ax2_upper]:
...
plt.savefig(f'{dir_fig_output}FIG5_additional_region.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{dir_fig_output}FIG5_additional_region.pdf', dpi=300, bbox_inches='tight')
