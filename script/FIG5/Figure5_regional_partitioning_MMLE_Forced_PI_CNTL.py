...
SOP_unforced_lower = xr.open_dataset(f'{dir_SOP_percentile}internal_SOP_trend_lower_percentile.nc')
...
SOP_unforced_upper = xr.open_dataset(f'{dir_SOP_percentile}internal_SOP_trend_upper_percentile.nc')
# %%
...
plt.savefig(f'{dir_fig_output}FIG5_piControl.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{dir_fig_output}FIG5_piControl.pdf', dpi=300, bbox_inches='tight')
